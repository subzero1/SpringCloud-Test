...
public class DateGetUtil {
	...
	public static String getCurrentDateString () {
        ...
        strDateTime.append(String.format("%04d", nowtime.get(Calendar.YEAR)));
        strDateTime.append(String.format("%02d", (nowtime.get(Calendar.MONTH))+1));
        strDateTime.append(String.format("%02d", nowtime.get(Calendar.DATE)));
        strDateTime.append(String.format("%02d", nowtime.get(Calendar.HOUR)));
        strDateTime.append(String.format("%02d", nowtime.get(Calendar.MINUTE)));
        strDateTime.append(String.format("%02d", nowtime.get(Calendar.SECOND)));
        strDateTime.append(String.format("%03d", nowtime.get(Calendar.MILLISECOND)));
...
//		System.out.println(addYear(new Date(),1));
		...
		//o.toString();
		System.out.println(DateGetUtil.getCurrentDateString());
	}
}
